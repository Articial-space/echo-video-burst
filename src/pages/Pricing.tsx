        ...
        <main className="container mx-auto px-4 py-12">
          ...
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Start free and scale as you grow. All plans include our core AI-powered video analysis features.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
            {plans.map((plan, index) => (
              <Card 
                key={index} 
                className={`relative p-8 glass-effect border-0 ${
                  plan.popular 
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-brand-gradient text-white px-4 py-1 rounded-full text-sm font-medium flex items-center space-x-1">
          ...
          <div className="text-center space-y-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto text-left">
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground text-sm">
                  We support all major video formats including MP4, MOV, AVI, and direct URLs from YouTube, Vimeo, and more.
                </p>
              </div>
              ...
              <div className="space-y-3">
                ...
                <p className="text-muted-foreground text-sm">
                  Our AI achieves 95%+ accuracy by analyzing both audio transcription and visual context for comprehensive summaries.
                </p>
              </div>
            </div>
          </div>
